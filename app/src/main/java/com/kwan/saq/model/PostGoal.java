...
public class PostGoal {
    ...
    public PostGoal(int id, int customer_id, String name, String start_date, String end_date, float calo, float calo_left, float calo_done, int status, float result, String created_at, String updated_at, String deleted_at) {
        this.id = id;
